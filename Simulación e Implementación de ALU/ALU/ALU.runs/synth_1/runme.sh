...
HD_PWD='C:/Users/diego/ALU/ALU.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log custom_alu.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source custom_alu.tcl
