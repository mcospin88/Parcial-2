...
HD_PWD='C:/Users/diego/Elvador_FSM/Elvador_FSM.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log elevator_fsm.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source elevator_fsm.tcl
